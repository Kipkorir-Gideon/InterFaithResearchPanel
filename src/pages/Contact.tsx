      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-8">
            Have questions or want to learn more about our work? Reach out to us using the contact information below or fill out the form.
          </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`flex items-center px-6 py-3 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                >
                  {isSubmitting ? (
                    <>
